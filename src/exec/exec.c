...
/* 0x24 */    and_i2r_b, and_i2r_v, es_override, inv,
...
/* 0x34 */    xor_i2r_b, xor_i2r_v, ss_override, inv,
/* 0x38 */    cmp_r2rm_b, cmp_r2rm_v, cmp_rm2r_b, cmp_rm2r_v, 
/* 0x3c */    cmp_i2r_b, cmp_i2r_v, ds_override, inv, 
...
/* 0xc0 */    group_c0, group_c1, ret_imm16_v, ret_near_v,
/* 0xc4 */    inv, inv, mov_i2rm_b, mov_i2rm_v,
/* 0xc8 */    inv, leave_l, inv, inv,
/* 0xcc */    int3, int_i, inv, iret_v,
/* 0xd0 */    group_d0, group_d1, group_d2, group_d3,
/* 0xd4 */    inv, inv, inv, inv,
/* 0xd8 */    inv, fldz, inv, inv,
/* 0xdc */    inv, fstp_mem_l, inv, inv,
...
/* 0xf4 */    hlt, inv, group_f6, group_f7,
/* 0xf8 */    inv, inv, cli, sti,
/* 0xfc */    cld, std, group_fe, group_ff
};
...
/* 0x40 */    cmovno_v, cmovno_v, cmovb_v, cmovae_v,
...
helper_fun group_table_f6[8] = {
    ...
    mul_rm2r_b, imul_rm2imp_b, div_rm2imp_b, idiv_rm2imp_v
};

helper_fun group_table_f7[8] = {
    test_i2rm_v, inv, not_rm_v, neg_rm_v,
    mul_rm2r_v, imul_rm2imp_v, div_rm2imp_v, idiv_rm2imp_v
};
